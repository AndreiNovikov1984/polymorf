...
public class Practicum {
    ...
    public static Phone getPhone(int type, String number) {
        if (type == 1) {
            Phone cellularPhone = new CellularPhone(number); // Если выбран стационарный телефон, создайте объект класса CellularPhone
            return new CellularPhone(number);
        } else if (type == 1) {
            MobilePhone mobilePhone = new MobilePhone(number); // Если выбран мобильный телефон, создайте объект класса MobilePhone
